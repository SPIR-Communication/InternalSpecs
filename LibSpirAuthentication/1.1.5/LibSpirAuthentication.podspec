Pod::Spec.new do |s|
  ...
  s.exclude_files = 'Classes/Models/SPIRUser/SPIRUser.{m,h}',
                    'Classes/Models/Common/SPIRFunction.{m,h}'
  
  s.subspec 'SPIRUser' do |sp|
    sp.source_files = 'Classes/Models/SPIRUser/SPIRUser.{m,h}'
  end

  s.subspec 'SPIRFunction' do |sp|
    sp.source_files = 'Classes/Models/Common/SPIRFunction.{m,h}'
  end
