...
Pod::Spec.new do |s|
  ...
  s.subspec "Parse" do |parse|
    parse.source_files = "Pod/Classes/Parse/*"
    parse.dependency 'LibLog/Core'
    parse.dependency 'LibTraceParse'
  ...
  s.subspec "WSLogSpir" do |wslogspir|
    ...
    wslogspir.dependency 'LibWSKit','~>2.0.1'
  end

  s.subspec "Core" do |core|
    core.source_files = "Pod/Classes/Core/*"
    core.dependency 'LibSpirCore','~>1.3.0'
  end
